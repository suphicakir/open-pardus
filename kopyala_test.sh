#!/bin/bash
# Dosya Kopyalama Programı (rsync)

# Dosya Kopyala
# rsync -avrpogtP /home/suphicakir /media/depo/yedeklerim/ 2> /tmp/stderr.txt
###############################################################################
# Ortam Değişkenleri
BACKTITLE="Dosya Kopyalama Uygulaması (rsync) v.1.0.0."
STDOUT=/tmp/stdout.txt.$$
STDERR=/tmp/stderr.txt.$$
STDMEN=/tmp/stdmen.txt.$$
STDEKR=/tmp/stdekr.txt.$$
KAYNAK=/home
HEDEF=/media/depo/yedeklerim
